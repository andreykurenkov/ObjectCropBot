...
When initialized, it loads a pre-trained DeepCrop and create the refinement
modules.
SharpCrop class members:
  - self.trunk: common trunk (from trained DeepCrop model)
  - self.scoreBranch: score head architecture (from trained DeepCrop model)
  - self.maskBranchDM: mask head architecture (from trained DeepCrop model)
...
local SharpCrop, _ = torch.class('nn.SharpCrop','nn.Container')

--------------------------------------------------------------------------------
-- function: init
function SharpCrop:__init(config)
...
function SharpCrop:createVertical(config)
  local netvs = {}
...
function SharpCrop:createHorizontal(config)
  local neths = {}
...
function SharpCrop:refinement(neth,netv)
...
function SharpCrop:createTopDownRefinement(config)
...
--------------------------------------------------------------------------------
-- function: forward
function SharpCrop:forward(input)
  -- forward bottom-up
...
--------------------------------------------------------------------------------
-- function: backward
function SharpCrop:backward(input,gradOutput)
...
function SharpCrop:setnpinference(np)
...
function SharpCrop:inference(np)
  self:evaluate()
